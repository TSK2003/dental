...
const FloatingActions = ({ onOpenAppointment }) => {
  ...
  const handleWhatsApp = () => {
    const text = encodeURIComponent(
      "Hello DentaCare, I would like to consult a Dental Specialist / inquire about Dental Implants, Invisalign, Root Canals & Smile Makeovers."
    );
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end space-y-3">
      ...
      <button
        ...
        aria-label="WhatsApp Dental Consultation"
      >
      ...
      <a
        ...
        className="w-12 h-12 bg-cyan-600 hover:bg-cyan-700 text-white shadow-lg shadow-cyan-200 rounded-full flex items-center justify-center transition-all hover:scale-105"
        aria-label="Call Dental Helpline"
      >
      ...
      <button
        ...
        className="px-5 py-3 bg-gradient-to-r from-cyan-600 to-sky-600 hover:from-cyan-700 hover:to-sky-700 text-white font-bold text-xs rounded-full shadow-xl shadow-cyan-200 flex items-center space-x-2 transition-all hover:scale-105 cursor-pointer border border-cyan-400"
      >
