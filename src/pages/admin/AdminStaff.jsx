...
const shiftOptions = [
  'Morning Surgical Shift (08:00 - 15:30)',
  'Evening Operatory Shift (13:30 - 20:30)',
  '3D CBCT Imaging Shift (08:30 - 17:00)',
  'Sterilization & Autoclave Shift (07:30 - 16:00)',
  '24/7 Dental Emergency Shift'
];

const categoryOptions = [
  'Dental Specialist',
  'Registered Dental Hygienist',
  'Chairside Surgical Assistant',
  'Sterilization Officer',
  'CAD/CAM Lab Ceramiste'
];

const emptyStaff = {
  empId: '',
  name: '',
  category: 'Registered Dental Hygienist',
  role: '',
  department: 'Implantology & Surgical Suites',
  assignedWard: 'Implant Operatory Suite #1',
  shift: 'Morning Surgical Shift (08:00 - 15:30)',
  dutyStatus: 'On Duty',
  phone: '',
  email: '',
  qualification: ''
...
const AdminStaff = () => {
  ...
  const openAdd = () => {
    ...
    setForm({
      ...emptyStaff,
      empId: `DNT-EMP-${Math.floor(100 + Math.random() * 900)}`
    });
    setShowModal(true);
  };
    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-slate-200 pb-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h1 className="text-xl font-black text-slate-950 flex items-center space-x-2 font-heading">
            ...
            <span>Dental Hygienists, Chairside Assistants & Clinical Staff</span>
          </h1>
          <p className="text-xs text-slate-500 mt-0.5">
            Real-time management of dental hygienists, chairside nurses, sterilization officers, and dental lab ceramists.
          </p>
        </div>
        <button
          onClick={openAdd}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm space-y-1">
          ...
          <span className="text-[10px] text-cyan-600 font-semibold">Hospital Roster</span>
        </div>
        <div className="bg-emerald-50/60 p-5 rounded-3xl border border-emerald-200 shadow-sm space-y-1">
          ...
          <span className="text-[10px] text-emerald-700 font-medium">In Operatory Suites</span>
        </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Search by name, employee ID, role, or operatory suite..."
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="bg-slate-50 text-left border-b border-slate-200 font-bold text-slate-700 uppercase text-[10px] tracking-wider">
                ...
                <th className="px-5 py-3.5">Specialty & Assigned Operatory</th>
              ...
              {filteredStaff.map((s) => (
                <tr key={s.id} className="hover:bg-slate-50/80 transition-colors">
                  <td className="px-5 py-4">
                    <span className="font-mono text-[10px] text-cyan-600 font-bold block">{s.empId}</span>
                  ...
                  <td className="px-5 py-4">
                    ...
                    <span className="text-[11px] text-cyan-600 font-semibold">{s.assignedWard}</span>
                  </td>
                  <td className="px-5 py-4">
          ...
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 space-y-4 shadow-2xl border border-slate-200 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <h3 className="text-base font-bold text-slate-950 font-heading">
                {editingId ? 'Edit Dental Staff Member' : 'Add New Dental Staff Member'}
              </h3>
            ...
            <form onSubmit={handleSave} className="space-y-3 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    placeholder="e.g. Lead Registered Dental Hygienist"
                    value={form.role}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block font-bold text-slate-700 mb-1">Assigned Operatory</label>
                  <input
                    type="text"
