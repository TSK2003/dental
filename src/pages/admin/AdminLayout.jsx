...
const sidebarLinks = [
  { to: '/admin/dashboard', label: 'Dental ERP Dashboard', icon: LayoutDashboard },
  { to: '/admin/beds', label: 'Operatory Suites & Chairs', icon: BedDouble },
  { to: '/admin/staff', label: 'Dental Hygienists & Lab Staff', icon: Users },
  { to: '/admin/appointments', label: 'Consultation Tokens & Queue', icon: CalendarCheck },
  { to: '/admin/doctors', label: 'Specialist Dentists Directory', icon: UserRound },
  { to: '/admin/departments', label: 'Specialties & 3D Units', icon: Layers3 },
  { to: '/admin/branches', label: 'Dental Centers & Hubs', icon: MapPin },
  { to: '/admin/technologies', label: '3D CBCT & Laser Equipment', icon: Cpu },
  { to: '/admin/blog', label: 'Dental Journal & Articles', icon: FileText },
  { to: '/admin/hospital-info', label: 'Hospital Profile & Emergency', icon: Building2 },
          ...
          <div className="p-4 border-b border-slate-800">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2.5">
                <div className="w-8 h-8 bg-gradient-to-br from-cyan-600 to-sky-600 rounded-lg flex items-center justify-center text-white font-bold shadow-md">
                  <Smile className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-sm font-black text-white tracking-wide uppercase font-heading">{hospitalInfo.name || 'DENTACARE'}</p>
                  <p className="text-[10px] text-cyan-400 font-bold uppercase tracking-wider">Dental Surgical ERP</p>
                </div>
              </div>
              <button
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center space-x-2.5 px-3 py-2 rounded-xl text-xs font-semibold transition-colors ${
                      isActive
                        ? 'bg-gradient-to-r from-cyan-600 to-sky-600 text-white font-bold shadow-md shadow-cyan-900/30'
          ...
          <div className="p-3 border-t border-slate-800 space-y-1">
            ...
            >
              <span className="flex items-center space-x-2">
                ...
                <span>View Live Dental Portal</span>
              </span>
            </a>
        ...
        <header className="sticky top-0 z-30 bg-white border-b border-slate-200 shadow-2xs">
          <div className="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-sm font-bold text-slate-800 hidden sm:block font-heading">
                DentaCare Hospital & Center for Advanced Implantology Management ERP
              </h1>
            </div>
            ...
            <div className="flex items-center space-x-3 text-xs">
              <span className="inline-flex items-center px-2.5 py-1 rounded-full text-[11px] font-bold bg-emerald-50 text-emerald-800 border border-emerald-200">
                ...
                Operatory Suites System Online
              </span>
              <div className="hidden sm:block text-right">
                <p className="font-bold text-slate-900">Dr. Arthur Vance</p>
                <p className="text-[10px] text-slate-500">Chief Clinical Director</p>
              </div>
            </div>
          </div>
        </header>
